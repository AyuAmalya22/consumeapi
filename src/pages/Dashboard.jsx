...
import { BarChart, Bar, CartesianGrid, Legend, ResponsiveContainer, Tooltip, YAxis, XAxis } from "recharts";
...
export default function Dashboard() {
    ...
    useEffect(() => {
        console.log("Data untuk grafik:", lendingGrouped);
    }, [lendingGrouped]);
...
//     // Menggunakan Set untuk menyimpan ID peminjam unik
//     const borrowerIds = new Set();

//     // Iterasi melalui setiap entri peminjaman
//     lendingGrouped.forEach((entry) => {
//         // Ambil setiap ID peminjam dari entri peminjaman saat ini
//         entry.borrowers.forEach((borrower) => {
//             // Tambahkan ID peminjam ke dalam Set
//             borrowerIds.add(borrower.id);
//         });
//     });

//     // Mengembalikan jumlah total peminjam yang unik
//     return borrowerIds.size;
// }

// // Di dalam komponen Dashboard
// const totalBorrowers = getTotalBorrowers();
            ...
            <div className="p-4 w-1/2">
                    <div className="flex rounded-lg h-full dark:bg-gray-800 bg-teal-400 p-8 flex-col">
                        <div className="flex items-center mb-3">
                            ...
                            <h2 className="text-white dark:text-white text-lg font-medium">Total Peminjam</h2>
                        </div>
                        <div className="flex flex-col justify-between flex-grow">
