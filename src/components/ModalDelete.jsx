...
export default function ModalDelete({ isOpen, onClose, endpoint, identitasColumn }) {
    ...
    useEffect(() => {
        if (isOpen) {
            console.log('Fetching data detail from:', endpoint['data_detail']);
    ...
    function handleDelete() {
        console.log('Deleting data from:', endpoint['delete']);
    ...
    return (
        <div id="popup-modal" tabIndex="-1" role="dialog" aria-modal="true" className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
